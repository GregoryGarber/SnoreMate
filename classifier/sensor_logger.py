...
def predict(window):
    ...
    # access lables with correct index. features returns index + name, grab that!
    # use index to access line 69
    ...
    print(window)
    features, x = extract_features(window)
    print("ran extract features")
    print("prinitng x")
    print(x)
    # X.append(x)
    # Y.append(window[10, -1])
    print(classifier)
